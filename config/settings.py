...
# Database
# Check if running on Cloud Run (using Cloud SQL)
CLOUD_SQL_CONNECTION_NAME = config('CLOUD_SQL_CONNECTION_NAME', default='')
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://localhost:3001,http://localhost:8001,http://127.0.0.1:3000,http://127.0.0.1:3001,http://127.0.0.1:8001,https://lislab.kr,https://www.lislab.kr,https://lislab-frontend-326272454487.asia-northeast3.run.app'
).split(',')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@lis.com')
