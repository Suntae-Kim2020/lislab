...
content = Content.objects.create(
    ...
    slug="oai-ore-data-model",
    summary="OAI-ORE는 프로토콜이 아닌 RDF 기반의 데이터 모델입니다. 복합 디지털 객체의 집합과 관계를 표현하는 방법을 학생 눈높이에서 이해하기 쉽게 학습합니다. Aggregation, Resource Map 등 핵심 개념을 실제 예제로 확인할 수 있습니다.",
...
print(f"   - URL: http://localhost:3000/contents/{content.slug}")
